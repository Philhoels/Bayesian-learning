...
# Note that the first input argument of this function must be the one that
# we optimize on, i.e. the regression coefficients.
...
# Set as OLS estimate: as.vector(solve(crossprod(X,X))%*%t(X)%*%y); 
# Initial values by OLS
