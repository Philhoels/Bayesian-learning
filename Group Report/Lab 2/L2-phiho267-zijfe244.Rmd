...
mu_0     <- c(-10.68, 93.60, -85.83)  
# before c(-10, 100, -100), change into values given in the lm output
omega_0  <- 0.01 * diag(3)
v_0      <- 4
...
According to slide 11 in Lecture 5, too many knots may result in overfitting. We can use regularization prior to avoid such problem. Using 
$$\beta_i \sim N(\mu_0,\frac{\sigma^2}{\lambda}),\ \  where \ \ \Omega_0 = \lambda\cdot I_3, $$
...
```{r, eval = FALSE, echo=FALSE, out.width="350px", out.height="300px", fig.align = "center"}
...
# 1000 predictions for such example
