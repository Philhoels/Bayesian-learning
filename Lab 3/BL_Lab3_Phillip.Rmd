...
v_0 <- 1 ###########------------------------------- ?
#sigma2_0 <- 1 ###########------------------------------- ? 
sigma2_0 <- var(rainfall$precipitation) # the variacne of the data or #Var(x_bar) = sigma^2/n
# sigma
sigma2 <- rinvchisq(n = 1, df = v_0, scale = sigma2_0)
...
plot_converge_mu <- ggplot() + 
  ...
  labs(title = "Convergence of mean", x = "interation", y = "mean")

# converge of sigma 
plot_converge_sigma <-ggplot() + 
  geom_line(aes(x = Gibbs_sampling$iterations, y = variance_vec, color = "variance")) + 
  labs(title = "Convergence of variance", x = "interation", y = "variance")
...
ggplot(plot_data_q1aii, aes(x = plot_data_q1aii$mu, y = plot_data_q1aii$sigma2)) + 
  geom_point(aes(color = "Markov chains")) + 
  geom_point(aes(x = plot_data_q1aii$mu[1], y = plot_data_q1aii$sigma2[1], color = "start")) +
  geom_point(aes(x = plot_data_q1aii$mu[length(plot_data_q1aii$mu)], 
                 y = plot_data_q1aii$sigma2[length(plot_data_q1aii$sigma2)], color = "end")) +
  ggtitle("mu vs sigma2") + ylab("sigma2") + xlab("mu") +
  theme(legend.position = "bottom")

ggplot(plot_data_q1aii, aes(x = plot_data_q1aii$mu, y = plot_data_q1aii$sigma2)) + 
  geom_path(aes(color = "Markov chains")) + 
  geom_point(aes(x = plot_data_q1aii$mu[1], y = plot_data_q1aii$sigma2[1], color = "start")) +
  geom_point(aes(x = plot_data_q1aii$mu[length(plot_data_q1aii$mu)], 
                 y = plot_data_q1aii$sigma2[length(plot_data_q1aii$sigma2)], color = "end")) +
  ggtitle("mu vs sigma2") + ylab("sigma2") + xlab("mu") +
